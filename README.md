...
* 📖 在线 Wiki：[https://zwiki.gitbook.io/zwiki-docs](https://zwiki.gitbook.io/zwiki-docs)
* 💻 GitHub：[https://github.com/zzkkoo8/Zwiki](https://github.com/zzkkoo8/Zwiki)
...
| 分类                       | 主要内容                                            |
| ------------------------ | ----------------------------------------------- |
| [基建](infrastructure/)    | 硬件、系统、网络、基础服务与通用运维                              |
| [容器与云原生](cloud-native/)  | Docker、Kubernetes、K3s 的部署、运维与排障                 |
| [开发](development/)       | 工程平台、前后端技术栈、测试与开发工具                             |
| [AI](ai/)                | AI Coding、Vibe Coding、Skills、插件、模型接入、提示词与 AI 资源 |
| [项目](projects/)          | 持续维护项目的目标、架构、设计决策与实施文档                          |
| [Zwiki 使用与维护](wiki-ops/) | 日常维护、写入前检查、错误回退、文章规范和模板                         |
...
* 文章格式与质量遵循 [文章编写规范](wiki-ops/contributing.md)。
