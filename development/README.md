...
AI Coding、Vibe Coding、Coding Agent、Skills、插件、MCP、模型和提示词统一放到 [AI](../ai/) 分类，避免“开发”和“AI”重复维护同一主题。

## 内容入口

* [工程平台](platforms/)：GitHub、GitBook、Vercel、GitLab、CI/CD 等开发、协作和发布平台。
* [技术栈与工具](tooling.md)：前端、后端、全栈、设计和测试领域的主流技术栈与工具。
