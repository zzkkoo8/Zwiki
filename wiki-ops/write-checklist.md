...
4. “文档信息”通常控制在 10 项以内，使用 `- **字段**：值` 的键值列表；只有需要横向比较或多列结构化阅读时才使用表格。
5. 新增文章后更新 `SUMMARY.md` 索引。
6. 仅在分类入口需要变化时修改对应 `README.md`。
